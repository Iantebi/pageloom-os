...
import{DiscoveryManagementList}from"@/components/discovery-management-list";
export default function MasterPage(){const{membership}=useOrganization(),c=t("common");if(!membership||!["owner","admin"].includes(membership.role))return <Card><Empty title={c.adminRequiredTitle} description={c.adminRequiredDescription}/></Card>;return <div className="space-y-6"><DiscoveryManagementList/><MasterControlCenter/><ContentApprovalCenter/><PortalAccessCenter/><MasterSupportCenter/></div>}
