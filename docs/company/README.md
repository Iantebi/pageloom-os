# PageLoom company knowledge base

This directory is the internal, English-language operating source of truth for PageLoom. Customer-facing artifacts remain Hebrew-first and are generated through the versioned document engine.

## Company system

- [Business blueprint](BUSINESS-BLUEPRINT.md)
...
Every policy has an owner, review cadence, effective date, and change history in Git. Legal text is not operational until Israeli counsel and the owner approve its exact version. Financial assumptions are planning inputs, not accounting records. Protected actions remain approval-gated in the application.
