...
export const dailyFirestoreBackup=onSchedule({schedule:"30 2 * * *",timeZone:params.agencyTimezone,region:params.region,retryCount:3,memory:"512MiB",timeoutSeconds:540,serviceAccount:params.backupServiceAccount},exportFirestoreBackup);
...
export const backupFreshnessWatchdog=onSchedule({schedule:"every 6 hours",region:params.region,retryCount:3,memory:"512MiB"},runBackupFreshnessWatchdog);
